...
{\samepage 
\begin{tabular}{r}
\parbox{\textwidth}{  \raisebox{-14mm} {\includegraphics[height=3.5cm]{images/aau-stud-logo.pdf}}
...
\item {\bf Appendix count and type:} 3, Installation Guide / Configuration, MockUps, Burndowncharts \fxfatal{update}
...
\parbox{7cm}{
  ...
  \fbox{
    \parbox{6.5cm}{\bigskip
     {\vfill{\small \input{text/synopsis} \fxfatal{make}
     \bigskip}}
     }}
   \end{tabular}}
\end{tabular}}
