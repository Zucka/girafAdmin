...
\item {\bf Appendix count and type:} 5, Installation Guide and Configuration, Graphical Mockups of the GIRAF System,  Transcript of Meeting with the head of kindergarten (1/3 2013), Usability Testing Appendix, Color Theme
\item {\bf Finished on} Juni 4$^{th}$ 2012
\end{description}
\vfill } &
\parbox{7cm}{
  \vspace{.15cm}
