...
\usepackage{spverbatim} %Bruges til at indfÃ¸re wrapping i kodemiljÃ¸er, ellers er den magen til {verbatim}
\usepackage{bussproofs} %Bruges til at indføre derivationstræer
