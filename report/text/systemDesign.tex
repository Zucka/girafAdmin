...
\textbf{desktop:} Is simply the main directory for the dekstop version, since there might come some small variations between the desktop and the Android version of the system.\\
\\
